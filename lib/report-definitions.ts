...
export const reportDefinitions: ReportDefinition[] = [
  ...
  { id: "procurement-history", title: "Purchase List", description: "Local ETB supplier purchases. Use Import Purchases for USD invoices.", category: "Procurement", icon: Receipt, filters: ["location", "dateFrom", "dateTo", "supplier", "product", "category", "status", "paymentStatus", "search"], tableKey: "reportsPurchases" },
  ...
  { id: "purchased-items", title: "Purchased Items", description: "Line-level local ETB purchases with supplier and cost details.", category: "Procurement", icon: ClipboardList, filters: ["location", "dateFrom", "dateTo", "product", "category", "supplier", "search"], tableKey: "purchasesPurchasedItems" },
