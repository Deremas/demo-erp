      ...
      <ModalTablePage
        ...
        dialogDescription={
          resolvedSelectedUser
            ? "Update user details, assigned locations, and default location."
            : "Create a user account with role, assigned locations, password, and at least one login ID."
        }
          ...
          {...(resolvedSelectedUser
            ? {
                initialValues: {
                  ...
                  locationIds: resolvedSelectedUser.locationAssignments.map(
                    (assignment) => assignment.locationId,
                  ),
                  defaultLocationId: resolvedSelectedUser.defaultLocationId ?? "",
                },
              }
            : {})}
        />
