...
type AgentCollectionsPageProps = {
  searchParams?: Promise<RouteSearchParams>;
};

export default async function Page({ searchParams }: AgentCollectionsPageProps) {
  ...
  const [config, options] = await Promise.all([
    getTablePageConfig("salesAgentPayments", {
      ...filters,
      type: "AGENT",
      ...(customerId ? { customerId } : {}),
    }),
    getCustomerPaymentFormOptions(customerId, "AGENT"),
  ]);
  ...
  return (
    <ModalTablePage
      ...
      dialogTitle="Receive agent payment"
      dialogDescription="Collect full or partial payments against outstanding agent credit."
