  ...
  return (
    <div className="space-y-4">
      ...
      {validationMessages.length > 0 ? (
        <div className="rounded-3xl border border-[hsl(var(--brand-gold)/0.7)] bg-[hsl(var(--brand-gold)/0.20)] p-5 text-sm text-[hsl(var(--brand-gold-foreground))]">
          <div className="flex items-start gap-4">
            <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-[hsl(var(--brand-gold)/0.42)] text-[hsl(var(--brand-gold-foreground))]">
            ...
            <div className="space-y-3">
              ...
              <ul className="grid grid-cols-1 gap-x-6 gap-y-1 sm:grid-cols-2">
                {validationMessages.map((message) => (
                  <li key={message} className="flex items-center gap-2 text-xs font-medium text-[hsl(var(--brand-gold-foreground)/0.78)]">
                    <span className="h-1 w-1 rounded-full bg-[hsl(var(--brand-cyan))]" />
                    {message}
                  </li>
                ))}
              </ul>
