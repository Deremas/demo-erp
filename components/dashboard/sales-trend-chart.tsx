...
export function SalesTrendChart({ data }: { data: TrendPoint[] }) {
  ...
  if (!isMounted) return <div className="h-[320px] w-full bg-slate-50/50 rounded-2xl animate-pulse" />;

  return (
    <Card>
      <CardHeader>
        <CardTitle>Sales Last 7 Days</CardTitle>
        <CardDescription>Location-wide posted sales across available stock.</CardDescription>
      </CardHeader>
